<div class="<?php print $classes; ?>">
  ...
  <div class="products-tools clearfix">
      ...
      <form class="products-sortby" method="get" action="#">
            ...
            $itemsPerPage = isset($query['items_per_page']) ? $query['items_per_page'] : 9;
          ?>
          <div class="select-icon">
              <select name="showby" class="item-per-page">
                  <option value="6" <?php echo $itemsPerPage == 6 ? 'selected' : '';?>>Show by : &nbsp; 6</option>
                  <option value="9" <?php echo $itemsPerPage == 9 ? 'selected' : '';?>>Show by : &nbsp; 9</option>
                  <option value="12" <?php echo $itemsPerPage == 12 ? 'selected' : '';?>>Show by : &nbsp; 12</option>
                  <option value="18" <?php echo $itemsPerPage == 18 ? 'selected' : '';?>>Show by : &nbsp; 18</option>
