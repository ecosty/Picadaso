        ...
        <div class="product-main style1 clearfix">
          ...
          <div class="product-details-info">
              ...
              <div class="product-short">
                  ...
                  <p>
                    <strong class="black"><?php print t('Features and materials') ?></strong><br/>
                    <?php
                      $array = explode("|",$fields['field_product_features']->content);
                      for($i=0; $i < count($array); $i++) :
                        print $array[$i] . '<br />';
                      endfor;
                    ?>
                  ...
                  <p>
                    <strong class="black"><?php print t('Dimensions') ?></strong><br/><?php print $fields['field_product_dimensions']->content ?></p>
              </div>
