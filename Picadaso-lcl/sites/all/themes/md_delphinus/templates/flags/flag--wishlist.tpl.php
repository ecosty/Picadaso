...
?>
<?php if ($link_href): ?>
  <a href="<?php print $link_href; ?>" data-toggle="tooltip" data-placement="top" title="<?php print $link_text; ?>" class="<?php print $flag_classes ?> add_to_wishlist" rel="nofollow"><?php (strpos($flag_classes, 'unflag-action') !== FALSE) ? print '<i class="fa fa-heart-o"></i>' : print '<i class="fa fa-heart"></i>'; ?></a>
<?php else: ?>
