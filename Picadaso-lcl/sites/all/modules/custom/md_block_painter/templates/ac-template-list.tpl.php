...
<div class="page-template">
  <?php if ($type == PAGE_TEMPLATE || $type == 'block'):?>
  <div class="template-row">
    <a class="awe-tpl-add add-template-btn" href="#" data-type="page"><?php print ($type == PAGE_TEMPLATE) ? t('Add page template') : t('Add block template');?></a>
