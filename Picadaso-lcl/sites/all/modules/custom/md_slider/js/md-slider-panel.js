...
(function($) {
    var MdSliderPanel = function() {
        ...
        this.textBoxTemplate = '<div class="slider-item ui-widget-content item-text" data-top="0" data-left="0" data-width="100" data-height="50" data-borderstyle="solid" data-mdtclass="fdsfds" data-type="text" data-title="Text" style="width: 100px; height: 50px;"><div>Text</div><span class="sl-tl"></span><span class="sl-tr"></span><span class="sl-bl"></span><span class="sl-br"></span><span class="sl-top"></span><span class="sl-right"></span><span class="sl-bottom"></span><span class="sl-left"></span> </div>';
        this.imageBoxTemplate = '<div class="slider-item ui-widget-content item-image" data-top="0" data-left="0" data-width="100" data-height="50" data-borderstyle="solid" data-mdtclass="fdsfds" style="height: 80px;width: 80px;" data-type="image"><img width="100%" height="100%" src="http://files.megadrupal.com/other/image.jpg" /><span class="sl-tl"></span><span class="sl-tr"></span><span class="sl-bl"></span><span class="sl-br"></span><span class="sl-top"></span><span class="sl-right"></span><span class="sl-bottom"></span><span class="sl-left"></span></div>';
        this.videoBoxTemplate = '<div class="slider-item ui-widget-content item-video" data-top="0" data-left="0" data-width="100" data-height="50" data-borderstyle="solid" data-mdtclass="fdsfds" style="height: 80px;width: 80px;" data-type="video"><img width="100%" height="100%" src="http://files.megadrupal.com/other/video.jpg" /><span class="sl-tl"></span><span class="sl-tr"></span><span class="sl-bl"></span><span class="sl-br"></span><span class="sl-top"></span><span class="sl-right"></span><span class="sl-bottom"></span><span class="sl-left"></span></div>';
        ...
        this.initTab = function() {
            ...
            $(".md-tabs-head span.ui-icon-close").live("click", function() {
                ...
                if (settings.slide_id == -1) {
                    ...
                    $.post(location.protocol + '//' + location.host + Drupal.settings.basePath + Drupal.settings.pathPrefix + '?q=admin/structure/md-slider/slide/delete', {sid: settings.slide_id}, function(data_response) {
                        if (data_response == 'OK') {
                ...
                buttons: {
                    Save: function() {
                        ...
                        if($tab) {
                            ...
                            $.post(Drupal.settings.basePath + Drupal.settings.pathPrefix + '?q=admin/structure/md-slider/get-background-image', {fid: settings.background_image, slider_id: slid}, function(response) {
                                if (response) {
            ...
            $('.slide-choose-image-link').live('click', function() {
                var _self = $(this);

                Drupal.media.popups.mediaBrowser(function(files) {
                    var icon = files[0];
                    Drupal.settings.select_image = icon;
                    $("#slide-backgroundimage").val(icon.fid);
                    $("img", _self.next()).attr("src", icon.url);
                    _self.next().show();
                    _self.next().next().show();
                });
            });
            $('.slide-choose-thumbnail-link').live('click', function() {
                var _self = $(this);

                Drupal.media.popups.mediaBrowser(function(files) {
                    var icon = files[0];
                    Drupal.settings.select_image = icon;
                    $("#slide-thumbnail").val(icon.fid);
                    $("img", _self.next()).attr("src", icon.url);
                    _self.next().show();
                });
            });
        ...
        this.addTab = function() {
            ...
            $newTab = $("#tabs-" + self.tab_counter);
            $newTab.append($("#dlg-slide-setting").html()).data('timelinewidth', $('input[name=default-timelinewidth]').val());
            self.tabs.append($newTab);

            self.tabs.tabs('refresh');
            self.tabs.tabs('select', $(".md-tabs-head li").length-1);
        }
        ...
        this.setSlideSettingValue = function(setting) {
            ...
            if (setting.disabled)
                $("#disable-slide").attr("checked", true);
            else
                $("#disable-slide").attr("checked", false);
            ...
            if (setting && setting.custom_thumbnail != -1) {
                ...
                $.post(Drupal.settings.basePath + Drupal.settings.pathPrefix + '?q=admin/structure/md-slider/get-background-image', {fid: setting.custom_thumbnail, slider_id: slid}, function(response) {
            ...
            if (setting && setting.background_image != -1) {
                ...
                $.post(Drupal.settings.basePath + Drupal.settings.pathPrefix + '?q=admin/structure/md-slider/get-background-image', {fid: setting.background_image, slider_id: slid}, function(response) {
